...
- [ ] `docs/article/ruby/index.md` と 16 章の記事ファイルが作成済み
- [ ] `apps/ruby/design-pattern/` のテストがすべてパス（13 パターン分）
...
| 環境構築 | 1 | 4h | [ ] |
| 第 1 部: パターンとは何か | 3 | 8h | [ ] |
| 第 2 部: 振る舞いの取り扱い | 4 | 13h | [ ] |
| 第 3 部: 操作と関係の表現 | 4 | 11.5h | [ ] |
| 第 4 部: オブジェクトの作成と解釈 | 4 | 12.5h | [ ] |
| 仕上げ（バッファ） | - | 7h | [ ] |
| **合計** | **16** | **56h** | |
